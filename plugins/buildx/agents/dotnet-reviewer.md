...
effort: high
maxTurns: 16
skills: development-documentation, dotnet-conventions, dotnet-hexagonal-architecture
...
The session you operate in starts after the developer's hand-off says "build clean, tests GREEN". You have the developer's list of changed files and the test FQN(s) that passed.
